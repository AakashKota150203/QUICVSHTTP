...
BEGIN {
    ...
    require '/home/Kota/quic-vs-http2-cdn/openssl/openssl-3.3.0/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/Kota/quic-vs-http2-cdn/openssl/openssl-3.3.0/test/fips-and-base.cnf';
    shift;
